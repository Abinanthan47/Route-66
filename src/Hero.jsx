...
function Hero() {
  return (
    <div className="md:px-5">
      <div
        className="w-full h-screen flex flex-col bg-[url('/bgy1.jpg')] md:justify-center items-center border-black border md:rounded-2xl"
        style={{
      ...
      >
        <div
          className="hidden md:block absolute bg-[url('/bg-mob.jpg')] inset-0"
          style={{
